...
export function Login({ onLogin, onSwitchToSignup, onForgotPassword }: LoginProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Simulate success
      localStorage.setItem('patientprep_user', JSON.stringify({ email, loginTime: Date.now() }));
      onLogin();
    } catch (err) {
      ...
      <div className="max-w-sm mx-auto w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Sign in to access your healthcare companion
          </p>
        </div>
        ...
        <Card className="border-border/50 shadow-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={isLoading || googleLoading || biometricLoading}
            >
              {googleLoading ? (
                <>
                  <Loader2 className="w-4 h-4 mr-2 animate-spin" />
